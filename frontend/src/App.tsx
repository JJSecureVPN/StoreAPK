  ...
  return (
    <Router>
      <div className="min-h-screen bg-gradient-to-br from-dark-50 via-secondary-900 to-dark-100 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-primary-500/10 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-500/10 rounded-full translate-x-1/2 translate-y-1/2"></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-primary-400/5 rounded-full -translate-x-1/2 -translate-y-1/2 animate-pulse-glow"></div>
